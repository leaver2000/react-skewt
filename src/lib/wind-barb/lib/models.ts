 ...
 * @ignore
 */
export type PrivateWindBarbOptions = WindBarbBar & WindBarbSize & WindBarbConversionFactor & WindBarbTriangle & WindBarbDims & WindBarbZeroKnotsCircle & Partial<WindBarbCircle>;
